        ...
        dropdownItemStyles({
          ...
          className: renderProps.hasSubmenu
            ? twMerge([
                ...
                "data-open:bg-primary data-open:text-primary-content data-open:*:data-[slot=icon]:text-primary-content data-open:*:[.text-neutral-content]:text-primary-content",
                className,
              ])
            : className,
        }),
    ...
    >
      {(values) => (
        <>
            ...
            <>
              {values.selectionMode === "single" && (
                <span
                  ...
                  className="-mx-0.5 me-2 flex size-4 shrink-0 items-center justify-center **:data-[slot=indicator]:size-2.5 **:data-[slot=indicator]:shrink-0"
                >
                  <IconBulletFill data-slot="indicator" />
                </span>
              )}
              {values.selectionMode === "multiple" && (
                <IconCheck className="-mx-0.5 me-2 size-4" data-slot="checked-icon" />
              )}
            </>
          )}
          ...
          {values.hasSubmenu && (
            <IconChevronLgRight data-slot="chevron" className="absolute end-2 size-3.5" />
          )}
        </>
      )}
    </MenuItemPrimitive>
