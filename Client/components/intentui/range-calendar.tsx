                ...
                {(date) => (
                  <CalendarCell
                    ...
                    className={twMerge([
                      ...
                      "group/calendar-cell relative size-10 cursor-default outline-hidden [line-height:2.286rem] selection-start:rounded-s-lg data-selection-end:rounded-e-lg data-outside-month:text-neutral-content sm:size-9 sm:text-sm",
