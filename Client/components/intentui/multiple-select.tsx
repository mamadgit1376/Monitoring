        ...
        <>
          ...
          >
            ...
            >
              <TagList
                className={twMerge(
                  [...selectedKeys].length !== 0 && "flex flex-1 flex-wrap py-1.5 ps-2",
                  "[&_.jdt3lr2x]:last:-me-1 gap-1.5 outline-hidden",
            ...
            >
              <div className="flex w-full flex-row items-center justify-between px-2">
                ...
                <Button
                  ...
                  aria-label="Chevron"
                  className="ms-auto inline-flex items-center justify-center rounded-lg text-neutral-content outline-hidden"
                >
                  <IconChevronLgDown
                      ...
                      <Description className="block p-3">
                        {inputValue ? (
                          <>
                            ...
                            <strong className="font-medium text-neutral-content">{inputValue}</strong>
                          </>
                        ) : (
                          "No options"
                        )}
