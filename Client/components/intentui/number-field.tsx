  ...
  return (
    <Button
      className={composeTailwindRenderProps(
        className,
        "h-10 cursor-default pressed:text-primary-fg text-neutral-content group-disabled:bg-secondary/70 sm:pressed:bg-primary forced-colors:group-disabled:text-[GrayText]",
      )}
      slot={slot}
      {...props}
    >
